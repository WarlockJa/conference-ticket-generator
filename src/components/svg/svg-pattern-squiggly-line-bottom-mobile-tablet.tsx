...
export default function SVGPatternSquigglyLineBottomMobileTablet(
  ...
  return (
    <svg
      ...
      {...props}
    >
      <g clipPath="url(#pattern-bottom-mobile-a)">
        <path
          fill="url(#pattern-bottom-mobile-b)"
      ...
      <defs>
        ...
        <clipPath id="pattern-bottom-mobile-a">
